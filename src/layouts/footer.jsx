...
export const Footer = () => {
  ...
  return (
    <div>
      <div className="bg-slate-100 flex justify-around text-alpha py-20 px-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-3">
            <div
              ...
              className="w-full border-2 border-slate-200 rounded-lg p-2 flex items-center gap-3 bg-white"
            >
            ...
            <button className="border-2 text-alpha px-3 rounded-lg border-alpha">
              Subscribe
            </button>
          </div>
        </div>
